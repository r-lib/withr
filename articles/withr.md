...
[`defer()`](https://withr.r-lib.org/reference/defer.md) is the core
...
[`withr::defer()`](https://withr.r-lib.org/reference/defer.md) is
...
[`defer()`](https://withr.r-lib.org/reference/defer.md), by default, it
**adds** expressions to the **top** of the stack of deferred actions.
...
behaviour of [`defer()`](https://withr.r-lib.org/reference/defer.md)
...
[`defer()`](https://withr.r-lib.org/reference/defer.md) to have
...
[`withr::defer()`](https://withr.r-lib.org/reference/defer.md) schedule
actions to be executed when a certain environment goes out of scope,
most typically the execution environment of a function. But the `envir`
argument of
[`withr::defer()`](https://withr.r-lib.org/reference/defer.md) lets you
specify a *different* environment, which makes it possible to create
...
[`defer()`](https://withr.r-lib.org/reference/defer.md), we can! Here is
such a custom helper, called `local_digits()`.
...
|----|----|
| Set an R option | [`local_options()`](https://withr.r-lib.org/reference/with_options.md),[`with_options()`](https://withr.r-lib.org/reference/with_options.md) |
| Set an environment variable | [`local_envvar()`](https://withr.r-lib.org/reference/with_envvar.md), [`with_envvar()`](https://withr.r-lib.org/reference/with_envvar.md) |
| Change working directory | [`local_dir()`](https://withr.r-lib.org/reference/with_dir.md), [`with_dir()`](https://withr.r-lib.org/reference/with_dir.md) |
| Set a graphics parameter | [`local_par()`](https://withr.r-lib.org/reference/with_par.md), [`with_par()`](https://withr.r-lib.org/reference/with_par.md) |

We didn’t really need to write our own `local_digits()` helper, because
the built-in
[`withr::local_options()`](https://withr.r-lib.org/reference/with_options.md)
...
[`withr::defer()`](https://withr.r-lib.org/reference/defer.md) and
...
Here’s how [`defer()`](https://withr.r-lib.org/reference/defer.md) (and
all functions based on it) works in an interactive session.
