...
## Overview
withR makes working with global state in R safer and less error prone. Many functions in R modify global state, which makes programming difficult. withR allows you to do this temporarily, and safely. These functions set one of the global settings for duration of a block of code, then automatically reset it after the block is completed.
