...
with `scoped_`. The former reset their state as soon as the `code` argument has
...
There are also `with_()` and `scoped_()` functions to construct new `with_*`
and `scoped_*` functions if needed.
