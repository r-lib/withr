...
[withr 2.1.0](http://withr.tidyverse.org/news/index.html) is now available on CRAN!
...
strive to reset the previous state when the function exists.
...
whether it exits normally or with an error.
...
means the code is not run in the [First-In
